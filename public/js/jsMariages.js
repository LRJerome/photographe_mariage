...
window.addEventListener("load", () => {
    ...
    fetch("/Images/Mariages")
      ...
      .then((data) => {
        ...
        galTitle.textContent = `Voici les photos du mariage de (nom des maries) !`;
       console.log(data);
        ...
        images.forEach((image, index) => {
          ...
          // theImg.src = `Images/Mariages/${image}`;
          theImg.src = `${imagesPath}${image}`;
    ...
    function showSinglePict(index) {
      ...
      console.log("Image à charger :", `Images/Mariages/${images}`);
      ...
      // modalImg.src = `images/Mariages/${image}`;
      modalImg.src = `${imagesPath}${image}`;
